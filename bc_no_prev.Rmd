...
#loading data
no_bc_url <- getURL("https://raw.githubusercontent.com/Guscode/BachelorAllDay/master/df_NO.csv")
no_bc <- read.csv(text = no_bc_url)
...
pairs <- levels(as.factor(no_bc$Pair))

#Looping through all pairs
for(i in 1:length(pairs)){
  
  #Splitting train and test data
  train.data <- no_bc[!no_bc$Pair==pairs[i],]
  test.data <- no_bc[no_bc$Pair==pairs[i],]
