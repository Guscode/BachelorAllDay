...
for(i in 1:length(folds)){
  ...
  freq99_t <- round(0.0*nrow(test.data)) #getting numeric value for using 99.9% most frequent words
  ...
  print(paste("making random forest first bc, fold=", as.character(i), sep=" "))
